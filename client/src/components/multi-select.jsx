...
/**
 * @param {MultiSelectProps & React.ComponentPropsWithoutRef<'button'>} props
    ...
    <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
      <PopoverTrigger asChild>
        <Button
          ...
          className={cn(
            "flex w-full p-1 rounded-md border min-h-5 items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
            className
          )}
        >
